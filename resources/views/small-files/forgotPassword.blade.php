<form method="post"  onsubmit="event.preventDefault();">
    ...
    <div class="selectOpt">
        ...
        <input type="email" class="login-input-class-1" name="email" id="login-forgot-email-id"
            placeholder="Registered Email" path="note" maxlength="45" />
    ...
    <div class="modal-footer"
        ...
        <button type="submit" id="loginTextRecover" name="loginTextRecoverbtn" class="btn"
            style="background-color: rgb(255, 92, 92); color: white;"
            onclick="checkPasswordRecover('passRec');">Recover Password</button>
    </div>
</form>